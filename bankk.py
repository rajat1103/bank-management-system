...
ttk.Label(frame, text="Name", font=("Times New Roman", 12, "bold")).grid(row=1, column=0, padx=5, pady=5)
entry_name = ttk.Entry(frame)
entry_name.grid(row=1, column=1)

ttk.Label(frame, text="Type (S/C)", font=("Times New Roman", 12, "bold")).grid(row=2, column=0, padx=5, pady=5)
entry_type = ttk.Entry(frame)
entry_type.grid(row=2, column=1)

ttk.Label(frame, text="Amount", font=("Times New Roman", 12, "bold")).grid(row=3, column=0, padx=5, pady=5)
